// exports.contactMessage = (name, email, message) => {
//   return `<!DOCTYPE html>
//   <html lang="en">
//   <head>
//     <meta charset="utf-8" />
...
//         border-radius: 8px;
//         font-weight: 600;
//         box-shadow: 0 6px 18px rgba(221, 169, 40, 1);
//       }
...
//     <span class="preheader">New contact message received at Maazster from ${name} (${email}).</span>
...
//         <div class="card" aria-label="Sender details">
//           <label class="label">Full name</label>
//           <div class="value">${name}</div>
//         </div>

//         <div class="card" aria-label="Sender email">
//           <label class="label">Email address</label>
//           <div class="value"><a class="inline" href="mailto:${email}">${email}</a></div>
//         </div>

//         <div class="card" aria-label="Message">
//           <label class="label">Message</label>
//           <div class="message-box">${message}</div>
//         </div>

//         <div class="cta">
//           <!-- Reply button opens default mail client with the sender's email -->
//           <a class="btn" href="mailto:${email}?subject=Re:%20Your%20message%20to%20SK%20Engineering">Reply to ${name}</a>
//         </div>
...
// emailTemplates/contactMessage.js
